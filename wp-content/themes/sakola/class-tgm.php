...
add_action( 'tgmpa_register', 'sakola_register_required_plugins' );
 ...
 */
function sakola_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'     				=> esc_html__( 'Sakola Extra', 'sakola' ), // The plugin name
			'slug'     				=> 'sakola-extra', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/plugins/sakola-extra.zip', // The plugin source
		...
		array(
			'name'     				=> esc_html__( 'Contact Form 7', 'sakola' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'ACF Pro', 'sakola' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'Redux Framework', 'sakola' ), // The plugin name
			'slug'     				=> 'redux-framework', // The plugin slug (typically the folder name)
			//'source'   				=> 'https://downloads.wordpress.org/plugin/redux-framework.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			'name'     				=> esc_html__( 'Elementor', 'sakola' ), // The plugin name
